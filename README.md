...
- Без ключей сайт работает: карта отображается автоматически (OpenStreetMap / виджет Яндекса).
- Ключ Яндекс.Карт в `config.js` опционален — для встроенной карты API.
